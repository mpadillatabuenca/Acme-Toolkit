...
@Service
public class InventorChimpunUpdateService implements AbstractUpdateService<Inventor, Chimpun> {
	...
	@Override
	public void update(final Request<Chimpun> request, final Chimpun entity) {
		assert request != null;
		assert entity != null;
